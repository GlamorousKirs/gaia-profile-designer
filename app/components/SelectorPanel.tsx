...
export default function SelectorPanel({ onSelectSelector }: SelectorPanelProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-background p-3 gap-3 overflow-hidden">
      { }
      <div className="p-2.5 bg-card border border-border rounded-lg shadow-sm shrink-0">
        <div className="relative">
          ...
          <Input
            ...
            className="pl-8 h-9 text-[11px] bg-muted/20 border-border/60"
          />
        </div>
      </div>

      { }
      <div className="flex-1 overflow-y-auto bg-card border border-border rounded-lg shadow-sm p-1.5 min-h-0">
