...
import { Palette, Loader2, Download, Check, Copy } from "lucide-react"
	...
	return (
		<div className="flex flex-col gap-4">
			...
			<div className="p-4 border-t bg-secondary/20">
				<Button onClick={() => onSave(`url('${convertSvgToDataUrl(memoizedSvg)}')`)} className="w-full"><Check className="size-3.5 mr-2" /> Apply Header Logo</Button>
			</div>
		</div>
	)
}