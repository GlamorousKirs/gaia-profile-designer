(function () {
    // 1. Guard check: If a permanent pure-HTML custom menu is loaded, disable the script entirely
    ...
    // Avatar menu fallbacks (only runs if the permanent HTML menu above is absent)
