        ...
        try {
            ...
            if (avatarUrl) {
                discoveredItems.push({
                    ...
                    displayKey: 'avatarUrl: (String Asset Path)',
                    icon: Image
                })
            }
    ...
    const handleDeleteItem = async (targetItem: DataItem) => {
        try {
            ...
            if (targetItem.source === 'indexeddb') {
                ...
                if (targetItem.id === 'z-avatar') useProfileStore.setState({ avatarUrl: '' })
            }
                        ...
                        {activeTab === 'account' && (
                            <div className="space-y-8 animate-in fade-in duration-500">
                                <header>
                                    ...
                                    <p className="text-sm text-muted-foreground">Your authenticated details for the current session.</p>
                                </header>
                                ...
                                <div className="pt-6 border-t border-border space-y-4">
                                    ...
                                    {allItems.length > 0 ? (
                                        ...
                                        <div className="p-6 border border-dashed border-border rounded-md text-center bg-muted/5">
                                            <p className="text-xs text-muted-foreground">No active storage data or state components discovered inside this browser.</p>
                                        </div>
                                    )}
                                </div>
                                ...
                                <div className="pt-6 border-t border-border">
                                    <div className="p-6 border border-destructive/20 bg-destructive/10 rounded-md flex flex-col gap-4">
                                        <div className="flex gap-4 items-start">
                                            ...
                                            <div>
                                                <p className="text-sm font-bold text-destructive">Reset to Factory Settings</p>
