...
export function Hero() {
  return (
    <section className="relative flex min-h-screen w-full flex-col items-center justify-start overflow-hidden px-4 pt-32 md:pt-40 text-foreground">
      ...
      {             }
      <div className="z-10 flex w-full max-w-4xl flex-col items-center text-center mb-12 md:mb-16">
        <h1 className="text-4xl font-extrabold tracking-tight sm:text-6xl md:text-7xl lg:text-8xl bg-clip-text text-transparent bg-linear-to-b from-foreground to-foreground/70">
          GAIA PROFILE DESIGNER
        </h1>
        <p className="mt-6 mx-auto max-w-150 text-base md:text-lg text-muted-foreground tracking-wide">
          A css code editor for Gaia Online profiles.
        </p>
      ...
      {                             }
      <div className="relative w-full max-w-6xl z-10 px-2 animate-fade-in-up mb-20">
